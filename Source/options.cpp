...
GameplayOptions::GameplayOptions()
	...
	, noDeathDrop("No Death Drop", OptionEntryFlags::None, N_("No Death Drop"), N_("Disable Death Drop."), false)
	, automapTime("Draw time on auto-map", OptionEntryFlags::None, N_("Draw time on auto-map"), N_("Draw system time on auto-map."), false)
	, advancedItemsInfo("Advanced items info", OptionEntryFlags::None, N_("Advanced items info"), N_("Display advanced items info."), false)
    , keepManaShield("Keep Mana Shield", OptionEntryFlags::None, N_("Keep Mana Shield"), N_("Keep Mana Shield while switching levels."), false)
